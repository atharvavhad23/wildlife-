...
# Add backend to path so we can import wildlife_config
sys.path.insert(0, str(BASE_DIR))

# Import centralized config (all data/model paths)
...
# Wildlife data & models paths (centralized)
DATA_DIR = wildlife_config.DATA_DIR
MODELS_DIR = wildlife_config.MODELS_DIR
REPORTS_DIR = wildlife_config.REPORTS_DIR
